...
- Custom GPT is the primary UI (natural language)
- Google Sheets is the system of record
- Google Apps Script (GAS) exposes HTTP endpoints for CRUD + “best task right now”
...
- Screen recording: {{SCREEN_RECORDING_URL}}
